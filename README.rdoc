...
mkdir -p kgem_pagseguro/{lib/pagseguro,test}

##################### PARA EXECUTAR TESTE #####################
rake test

##################### PARA CRIAR O .GEM #####################
gem build kgem_pagseguro.gemspec

##################### RODAR GEM LOCAL #####################
gem install kgem_pagseguro-0.0.1.gem --local
depois inserir gem 'kgem_pagseguro' no arquivo Gemfile
